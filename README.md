...
This front-end application is provided as-is, as a part of the [Serverless Framework  - Node.js, AWS & Microservices].

## Cloning and installing
Clone this repository.
```
git clone https://github.com/vladimirpetukhov/CakeShop_Admin_Client
cd path
```
